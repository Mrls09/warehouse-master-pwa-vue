...
// const uid = isLoggedIn ? user.usuarios.uid : null;

// const baseUrl = '/calificaciones';

// const getCalificacionesByUser = async () => {
//   try {
//     const response = await axiosClient.get(`${baseUrl}/usuarios/${uid}`);
...
//   try {
//     const response = await axiosClient.post(`${baseUrl}/`, {...calificacion, usuario : {uid}})
